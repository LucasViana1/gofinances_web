...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formatTransactionAmount = response.data.transactions.map(
      ...
      setTransactions(formatTransactionAmount);
      setBalance(formatBalanceAmount);
      console.log(formatBalanceAmount, formatTransactionAmount);
    }
